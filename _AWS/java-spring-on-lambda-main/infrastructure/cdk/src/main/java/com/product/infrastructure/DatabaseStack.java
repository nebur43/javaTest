...
//                .credentials(Credentials.fromSecret(dbSecret))
                .credentials(Credentials.fromPassword("postgres", SecretValue.plainText("miPassword123")))
                .build());
        ...
        createDbSetupLambdaFunction(stackProps, dbInstance);
...
//    }
    ...
    private Function createDbSetupLambdaFunction(DatabaseStackProps props, DatabaseInstance database
